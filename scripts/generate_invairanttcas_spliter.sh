...
java -cp /home/soha/git/jpf-symbc/build/examples:/home/soha/git/jpf-symbc/lib/daikon/daikon.jar daikon.Daikon ../src/examples/tcas/TCAS_Output.spinfo ../traces_tcas/*.dtrace.gz --format java > ../daikonInv/daikon_invariants_tcas.txt
