...
java -cp /home/soha/git/jpf-symbc/build/examples:/home/soha/git/jpf-symbc/lib/daikon/daikon.jar daikon.Chicory --dtrace-file=../traces_infusion/infusionSteps5_targeted_instance.dtrace.gz infusionTargetedDaikon.Infusion_Daikon /home/soha/git/jpf-symbc/testCase/testCases_infusionP9.txt

echo "finish chicory starting collecting invariants."
java -cp /home/soha/git/jpf-symbc/build/examples:/home/soha/git/jpf-symbc/lib/daikon/daikon.jar daikon.Daikon --config_option daikon.inv.unary.scalar.OneOfScalar.size=7 ../src/examples/infusionTargetedDaikon/Infusion_Result_Instance.spinfo ../traces_infusion/infusionSteps5_targeted_instance.dtrace.gz --format java > ../daikonInv/infusion_targeted_instance_steps5.txt
