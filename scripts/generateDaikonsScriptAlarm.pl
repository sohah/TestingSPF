...
my $TC_FileName="/home/soha/git/jpf-symbc/testCase/testCases_alarm.txt";
my $symbolicMethodName="ALARM_FunctionalSymWrapper";
my $benchmark="alarm";
my $mainClassName="alarm.ALARM_Functional";
...
print DAIKONFH "rm ../traces_${benchmark}/*\n";
