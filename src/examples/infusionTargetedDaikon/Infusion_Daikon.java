    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (param.length != 110)
                    System.out.println("param= " + param.length +", line Number = "+lineNum +" ," + Arrays.asList(param).toString() + " invalid number of parameters to run the program. Assumptions violated. Failing.");
