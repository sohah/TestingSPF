...
class Alarm_Result_Instance {
    ...
    public static Alarm_Result_Instance step(int Commanded_Flow_Rate,
        ...
        Alarm_Result_Instance alarm_result = new Alarm_Result_Instance();
