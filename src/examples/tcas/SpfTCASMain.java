...
public class SpfTCASMain {
    ...
    public void DoSimSymbolic() {
        SpfTCAS.launch(601, -1, 0, -1, 0, 0, 0, 301, 400, 0, 0, 1,601, -1, 0, -1, 0, 0, 0, 301, 400, 0, 0, 1);
    }
    ...
    public void DoSimSymbolic(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12,
        ...
        SpfTCAS.launch(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,p21, p22, p23,p24);
    }
