...
public class INFUSION_MGR_Functional {
    ...
    static B_INFUSION_MGR_Functional_c_T localB;
    static DW_INFUSION_MGR_Functional_f_T localDW;
    ...
    static void INFUSION_MGR_FunctionalSymWrapper(
        ...
        rtu_TLM_MODE_IN_2.Log_Message_ID = Log_Message_ID1_2;


        Top_Level_Mode_Outputs rtu_TLM_MODE_IN_3 = new Top_Level_Mode_Outputs();
        rtu_TLM_MODE_IN_3.System_On = System_On_3;
        rtu_TLM_MODE_IN_3.Request_Confirm_Stop = Request_Confirm_Stop_3;
        rtu_TLM_MODE_IN_3.Log_Message_ID = Log_Message_ID1_3;
        ...
        rtu_OP_CMD_IN_3.System_Start = System_Start_3;
        rtu_OP_CMD_IN_3.System_Stop = System_Stop_3;
        rtu_OP_CMD_IN_3.Infusion_Initiate = Infusion_Initiate_3;
        rtu_OP_CMD_IN_3.Infusion_Inhibit = Infusion_Inhibit_3;
        rtu_OP_CMD_IN_3.Infusion_Cancel = Infusion_Cancel_3;
        rtu_OP_CMD_IN_3.Data_Config = Data_Config_3;
        rtu_OP_CMD_IN_3.Next = Next_3;
        rtu_OP_CMD_IN_3.Back = Back_3;
        rtu_OP_CMD_IN_3.Cancel = Cancel_3;
        rtu_OP_CMD_IN_3.Keyboard = Keyboard_3;
        rtu_OP_CMD_IN_3.Disable_Audio = Disable_Audio_3;
        rtu_OP_CMD_IN_3.Notification_Cancel = Notification_Cancel_3;
        rtu_OP_CMD_IN_3.Configuration_Type = Configuration_Type_3;
        rtu_OP_CMD_IN_3.Confirm_Stop = Confirm_Stop_3;
        ...
        Patient_Inputs rtu_PATIENT_IN_3 = new Patient_Inputs();
        rtu_PATIENT_IN_3.Patient_Bolus_Request = Patient_Bolus_Request_3;
        ...
        rtu_CONFIG_IN_3.Drug_Concentration = Drug_Concentration_3;
        rtu_CONFIG_IN_3.Infusion_Total_Duration = Infusion_Total_Duration_3;
        rtu_CONFIG_IN_3.VTBI_Total = VTBI_Total_3;
        rtu_CONFIG_IN_3.Flow_Rate_Basal = Flow_Rate_Basal_3;
        rtu_CONFIG_IN_3.Flow_Rate_Intermittent_Bolus = Flow_Rate_Intermittent_Bolus_3;
        rtu_CONFIG_IN_3.Duration_Intermittent_Bolus = Duration_Intermittent_Bolus_3;
        rtu_CONFIG_IN_3.Interval_Intermittent_Bolus = Interval_Intermittent_Bolus_3;
        rtu_CONFIG_IN_3.Flow_Rate_Patient_Bolus = Flow_Rate_Patient_Bolus_3;
        rtu_CONFIG_IN_3.Duration_Patient_Bolus = Duration_Patient_Bolus_3;
        rtu_CONFIG_IN_3.Lockout_Period_Patient_Bolus = Lockout_Period_Patient_Bolus_3;
        rtu_CONFIG_IN_3.Max_Number_of_Patient_Bolus = Max_Number_of_Patient_Bolus_3;
        rtu_CONFIG_IN_3.Flow_Rate_KVO = Flow_Rate_KVO_3;
        rtu_CONFIG_IN_3.Entered_Reservoir_Volume = Entered_Reservoir_Volume_3;
        rtu_CONFIG_IN_3.Reservoir_Volume = Reservoir_Volume_3;
        rtu_CONFIG_IN_3.Configured = Configured_3;
        rtu_CONFIG_IN_3.Error_Message_ID = Error_Message_ID_3;
        rtu_CONFIG_IN_3.Request_Config_Type = Request_Config_Type_3;
        rtu_CONFIG_IN_3.Request_Confirm_Infusion_Initiate = Request_Confirm_Infusion_Initiate_3;
        rtu_CONFIG_IN_3.Request_Patient_Drug_Info = Request_Patient_Drug_Info_3;
        rtu_CONFIG_IN_3.Request_Infusion_Info = Request_Infusion_Info_3;
        rtu_CONFIG_IN_3.Log_Message_ID = Log_Message_ID_3;
        rtu_CONFIG_IN_3.Config_Timer = Config_Timer_3;
        rtu_CONFIG_IN_3.Config_Mode = Config_Mode_3;
        ...
        rtu_ALARM_IN_2.Is_Audio_Disabled = Is_Audio_Disabled_2;
        rtu_ALARM_IN_2.Notification_Message = Notification_Message_2;
        rtu_ALARM_IN_2.Audio_Notification_Command = Audio_Notification_Command_2;
        rtu_ALARM_IN_2.Highest_Level_Alarm = Highest_Level_Alarm_2;
        rtu_ALARM_IN_2.Log_Message_ID = Log_Message_ID3_2;


        Alarm_Outputs rtu_ALARM_IN_3 = new Alarm_Outputs();
        rtu_ALARM_IN_3.Is_Audio_Disabled = Is_Audio_Disabled_3;
        rtu_ALARM_IN_3.Notification_Message = Notification_Message_3;
        rtu_ALARM_IN_3.Audio_Notification_Command = Audio_Notification_Command_3;
        rtu_ALARM_IN_3.Highest_Level_Alarm = Highest_Level_Alarm_3;
        rtu_ALARM_IN_3.Log_Message_ID = Log_Message_ID3_3;
        ...
        rtu_SYS_STAT_IN_2.Reservoir_Volume = Reservoir_Volume2_2;
        rtu_SYS_STAT_IN_2.Volume_Infused = Volume_Infused_2;
        rtu_SYS_STAT_IN_2.Log_Message_ID = Log_Message_ID2_2;
        ...
        rtu_SYS_STAT_IN_3.Volume_Infused = Volume_Infused_3;
        rtu_SYS_STAT_IN_3.Log_Message_ID = Log_Message_ID2_3;
        rtu_SYS_STAT_IN_3.In_Therapy = In_Therapy_3;
        ...
        rty_IM_OUT_2.Commanded_Flow_Rate = Commanded_Flow_Rate_2;
        rty_IM_OUT_2.Current_System_Mode = Current_System_Mode_2;
        rty_IM_OUT_2.New_Infusion = New_Infusion_2;
        rty_IM_OUT_2.Log_Message_ID = Log_Message_ID4_2;
        rty_IM_OUT_2.Actual_Infusion_Duration = Actual_Infusion_Duration_2;


        Infusion_Manager_Outputs rty_IM_OUT_3 = new Infusion_Manager_Outputs();
        rty_IM_OUT_3.Commanded_Flow_Rate = Commanded_Flow_Rate_3;
        rty_IM_OUT_3.Current_System_Mode = Current_System_Mode_3;
        rty_IM_OUT_3.New_Infusion = New_Infusion_3;
